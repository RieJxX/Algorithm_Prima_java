...
public class GraphEdgePanel extends JPanel {
    ...
    public void updateLabel(String startLabel, String endLabel) {
        // Update edge label with new node labels
        // You can update other related fields if necessary
        this.repaint();
    }
    ...
    public static void setSelectedEdge(GraphEdgePanel edge){
        selectedEdge = edge;
    }
